...
jalan("   \033[1;91m WIFI USERZ USE INDONESIA PROXY ")	

jalan("   \033[1;93m Welcome to MOHSIN  ALI SPCRIT ")

jalan("\033[1;97m•◈•──────────•◈•\033[1;96mTheMohsinVirus\033[1;96m•◈•──────────•◈•")
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open https://youtu.be/Z2_PQwXhLlA')
    else:
...
def menu():
	...
	print "\033[1;32;40m[2] \033[1;33;40m══Update MྂOྂHྂSྂIྂNྂ"																														
...
def pilih_super():
	...
	jalan('                    \033[1;97mMr MྂOྂHྂSྂIྂNྂ AྂLྂIྂ start cloning Wait...')
	print  "  \033[1;36;48m ●💋══════════════════◄►══════════════════💋●" 
